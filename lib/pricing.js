...
export const pricing = {
  pro: {
    ...
    annual: {
      ...
      checkoutUrl: 'https://buy.stripe.com/28E9AM8HudJZh1p7BE3sI0q',
    },
  },
  consulting: {
    starter: {
  ...
  // Active coupon — set by ~/bin/lo-campaign, null when no sale is running
  activeCoupon: null,
  // Example when a sale is active:
  // activeCoupon: {
  //   code: 'SUMMER25',
  //   name: 'Summer Sale',
  //   percentOff: 25,
  //   expires: '2026-07-01',
  //   stripeId: 'coupon_xxx',
  //   checkoutUrl: 'https://buy.stripe.com/xxx',  // checkout with coupon pre-applied
  // },
};
