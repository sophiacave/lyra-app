...
export const pricing = {
  pro: {
    monthly: {
      amount: 49,
      display: '$49/mo',
      priceId: 'price_1TEOqs2L9FGg4gn2uOIrrmRW',
      checkoutUrl: 'https://buy.stripe.com/bJe28k9LygWb7qP09c3sI0p',
    },
    annual: {
      amount: 390,
      display: '$390/yr',
      monthlyEquiv: '$32.50/mo',
      savePct: 33,
      priceId: 'price_1TEOr92L9FGg4gn2nh0q9tfl',
      checkoutUrl: 'https://buy.stripe.com/28E9AM8HudJZh1p7BE3sI0q?prefilled_promo_code=ANNUAL65',
    },
  },
  consulting: {
    starter: {
  ...
  // Active coupon — 65% off annual, auto-applied at checkout
  activeCoupon: {
    code: 'ANNUAL65',
    name: '65% Off Annual Plan',
    percentOff: 65,
    stripeId: 'RnDoI2ZD',
    promoId: 'promo_1TXlHb2L9FGg4gn2QXZrW8Pk',
    salePrice: 136.50,
    salePriceDisplay: '$136.50/yr',
    saleMonthlyEquiv: '$11.38/mo',
  },
};
