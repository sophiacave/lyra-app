...
export default function AcademyCatalogClient({ tiers, allCourses, totalLessons }) {
  ...
  return (
    <div className="academy-container-wide">
      ...
      <div className="academy-v2-pricing">
        <span>First 3 lessons of every course — free. Full access from <strong>$49/mo</strong>.</span>
