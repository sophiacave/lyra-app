  ...
  return (
    <SiteLayout>
      ...
      <ul className="legal-ul">
        <li className="legal-li"><strong>Pro Monthly:</strong> $19/month, billed monthly via Stripe</li>
        <li className="legal-li"><strong>Pro Annual:</strong> $149/year, billed annually via Stripe</li>
