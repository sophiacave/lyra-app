...
const TIPS: WeeklyTip[] = [
  ...
  // Tip 8
  {
    ...
    html: buildEmail(
      ...
      <p>Everything I've shared in these tips is the beginning. The academy goes deeper — 52 courses, 520+ lessons, from fundamentals to building production AI systems.</p>
