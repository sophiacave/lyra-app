...
const TIPS: WeeklyTip[] = [
  ...
  // Tip 8
  {
    ...
    html: buildEmail(
      ...
      <p>Everything I've shared in these tips is the beginning. The academy goes deeper — 36 courses, 355+ lessons, from fundamentals to building production AI systems.</p>
      <p>Get full access for <strong style="color:#fb923c">$49/mo</strong> — or save 33% with annual at $390/yr.</p>
