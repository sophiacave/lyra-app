...
const SEQUENCE: NurtureEmail[] = [
  {
    ...
    html: buildEmail(
      ...
      <p>I became a cyborg. Not in the sci-fi way — in the <em>"I can now do in one day what used to take me a week"</em> way.</p>
      <p>Like One Academy teaches what I learned. Not the theory — the <strong>actual system</strong>. From zero to cyborg, with no gatekeeping and no jargon walls.</p>
  ...
  },
  {
    ...
    html: buildEmail(
      ...
      <p>Every dollar goes toward building convergence tech, funding HIV research, and keeping AI accessible to everyone. That's the mission.</p>
...
<div style="max-width:560px;margin:0 auto;padding:40px 24px;">
  ...
  <div style="border-top:1px solid #1e1e28;margin-top:40px;padding-top:20px;text-align:center">
    ...
    <p style="color:#444;font-size:11px;margin:8px 0 0"><a href="mailto:faye@likeone.ai?subject=Unsubscribe" style="color:#444;text-decoration:underline">Unsubscribe</a></p>
  </div>
</div>
</body></html>`;
}
