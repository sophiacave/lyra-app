...
**Q1: Why does chain-of-thought prompting improve accuracy on complex tasks?**
    A. It makes the AI use more tokens
  ✓ B. It forces the model to reason through intermediate steps before concluding
    C. It gives the AI a longer time limit
    D. It switches the AI to a different model
  *CoT prompting requires the AI to work through reasoning steps before reaching a conclusion, reducing the chance of jumping to a wrong answer — like giving it scratch paper.*

**Q2: When should you SKIP chain-of-thought prompting?**
    A. Math problems
    B. Code debugging
  ✓ C. Translation and simple factual questions
    D. Strategic analysis
  *CoT adds value for reasoning-heavy tasks but creates noise for simple tasks like translation, factual lookups, or formatting where direct answers are better.*

**Q3: What does a ‘thinking budget’ prompt accomplish?**
    A. It limits how many tokens the AI can use
  ✓ B. It asks the AI to evaluate multiple approaches before recommending one
    C. It speeds up the AI’s response
    D. It prevents the AI from showing its reasoning
  *A thinking budget prompt asks the AI to consider multiple approaches, evaluate trade-offs for each, and then make a justified recommendation — maximizing reasoning depth.*


  [← Previous: System Prompts & Personas](/academy/advanced-prompt-engineering/02-system-prompts-and-personas/)
  [Next: Few-Shot & Examples →](/academy/advanced-prompt-engineering/04-few-shot-and-examples/)
