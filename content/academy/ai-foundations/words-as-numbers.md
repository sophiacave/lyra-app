...
<div data-learn="MatchConnect" data-props='{"title":"Match Embedding Concepts","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Vector","right":"A list of numbers representing a word\\\'s meaning"},{"left":"Semantic space","right":"The coordinate system where similar words cluster together"},{"left":"king - man + woman","right":"Vector arithmetic that captures gender and royalty relationships"},{"left":"Cosine similarity","right":"Measures the angle between two vectors to determine relatedness"},{"left":"Embedding model","right":"Learns word positions from patterns in billions of sentences"}]}'></div>
