...
<div class="lesson-section">
  ...
  <h2 class="section-title">Review the 5-minute prospect brief steps.</h2>
  <div data-learn="FlashDeck" data-props='{"title":"5-Minute Prospect Brief","cards":[{"front":"Step 1 — Company Snapshot","back":"Size, industry, recent funding, key products. Know what the company does and where it is in its growth stage."},{"front":"Step 2 — Contact Profile","back":"Role, tenure, likely priorities, career trajectory. Know who you are talking to and what they care about."},{"front":"Step 3 — Pain Point Analysis","back":"What problems does this company likely face given their stage and industry? Connect their situation to real challenges."},{"front":"Step 4 — Connection Mapping","back":"How does your product solve their specific problems? Map your solution to their pain before you get on the call."},{"front":"Lead Scoring — Hot","back":"80 to 100 score: strong ICP match, budget confirmed, active pain point, decision-maker engaged. Prioritize these."}]}'></div>
</div>
...
<div class="lesson-section">
  ...
  <div data-learn="QuizMC" data-props='{"title":"Lead Research and Qualification","questions":[{"q":"What does a hot lead (80-100 score) look like according to the lesson?","options":["They responded to a cold email","Strong ICP match, budget confirmed, active pain point, and decision-maker is engaged","They visited your website multiple times","They are a recognizable brand name in your target market"],"correct":1,"explanation":"A hot lead hits all four factors: strong ideal customer profile match, confirmed budget, active pain point they want to solve, and you are talking to the actual decision-maker. All four together signal a deal most likely to close quickly."},{"q":"What is the biggest mistake most salespeople make before a call?","options":["Preparing too much and sounding scripted","Walking in knowing almost nothing — skimming a LinkedIn profile and winging it","Spending too much time on research","Preparing for the wrong objections"],"correct":1,"explanation":"The lesson calls this selling blind — walking into calls knowing almost nothing about the prospect. A comprehensive brief covering company, contact, pain points, and objections takes minutes with AI and fundamentally changes the quality of every conversation."},{"q":"Why should you save and refine your research prompt template after every call?","options":["So AI learns from your feedback automatically","Consistency means every prospect gets the same thorough research treatment — and your close rate climbs because you never walk in unprepared","To comply with CRM documentation requirements","So you can share it with your team faster"],"correct":1,"explanation":"The lesson emphasizes: consistency is what separates professionals from amateurs. When every prospect gets the same thorough research treatment, your close rate climbs. Saving and refining your template makes it better every week without extra effort."},{"q":"What should a prospect brief include at minimum?","options":["Their company revenue and employee headcount","Company overview, contact priorities and pain points, product-to-problem mapping, conversation starters, and likely objections","A list of their competitors and market position","Their technology stack and current software vendors"],"correct":1,"explanation":"The lesson prompt generates five elements: company overview and recent news, contact priorities and pain points, product-to-problem mapping, three conversation starters showing you did your homework, and likely objections with handling approaches."}]}'></div>
</div>
