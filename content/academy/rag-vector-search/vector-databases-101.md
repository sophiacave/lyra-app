...
<span style="color:#71717a"># [["Our refund policy allows returns within 30 days."]]</span></code></pre>
  ...
  <div data-learn="SortStack" data-props='{"title":"How a Vector Search Works — Put the Steps in Order","instruction":"Arrange these steps in the correct sequence for a vector similarity search","items":["Convert user query to an embedding vector","Navigate the HNSW graph to find candidate nearest neighbors","Compare query vector against candidates using cosine similarity","Rank results by similarity score","Return the top-K most similar document chunks with metadata"]}'></div>
