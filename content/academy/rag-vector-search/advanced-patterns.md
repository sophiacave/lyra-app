...
<div class="container">
  ...
  <div data-learn="MatchConnect" data-props='{"title":"Match the Pattern to Its Use Case","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Multi-Step RAG","right":"Vague query that needs vocabulary refinement before precise retrieval"},{"left":"Self-RAG","right":"Mixed workload where some questions need retrieval, others don't"},{"left":"RAG + Tools","right":"Financial question requiring retrieval plus numeric calculation"},{"left":"Agentic RAG","right":"Complex query spanning product, billing, and technical knowledge bases"},{"left":"Basic RAG","right":"Simple, precise question with a single knowledge source"}]}'></div>
