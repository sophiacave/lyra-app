...
<div class="container">
  ...
  <div data-learn="MatchConnect" data-props='{"title":"Match the Metric to What It Detects","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Faithfulness","right":"Answer contains claims not in the retrieved context"},{"left":"Context Relevance","right":"Retrieved chunks are unrelated to the user question"},{"left":"Completeness","right":"Answer omits important details present in the context"},{"left":"Answer Relevance","right":"Answer does not address what the user actually asked"},{"left":"RAGAS","right":"Open-source automated RAG evaluation framework"}]}'></div>
