...
<div class="container">
  ...
  <div data-learn="MatchConnect" data-props='{"title":"Match Conscience Tiers","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Tier 1: Prime Directives","right":"Never harm, never deceive — highest priority rules"},{"left":"Tier 2: Identity","right":"Consistent voice, user respect, and preferences"},{"left":"Tier 3: Operations","right":"Budget limits, logging rules, and business constraints"},{"left":"Tier 4: Safety","right":"Never expose credentials, validate all inputs"},{"left":"Tier 5: Tasks","right":"The actual work — lowest priority, always subordinate"}]}'></div>
