...
<div class="container">
  ...
  <div data-learn="MatchConnect" data-props='{"title":"Match Agent to Role","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Writer","right":"Creates blog posts and social copy"},{"left":"Guardian","right":"Enforces rules and compliance"},{"left":"Monitor","right":"Watches for errors and anomalies"},{"left":"Notifier","right":"Sends Slack and email alerts"},{"left":"Scheduler","right":"Manages cron jobs and queues"}]}'></div>
