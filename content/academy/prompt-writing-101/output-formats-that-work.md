...
<div data-learn="MatchConnect" data-props='{"title":"Pick the Right Format","instruction":"Match each situation to the best output format","pairs":[{"left":"Quick update in Slack about this week progress","right":"Bullet points — scannable and efficient"},{"left":"Deciding between AWS and GCP for your infrastructure","right":"Table / comparison — side-by-side evaluation"},{"left":"Onboarding guide for new team members","right":"Step-by-step — numbered process instructions"},{"left":"Telling your VP the quarterly results","right":"Executive summary — bottom line first"},{"left":"Building a config file for your deploy pipeline","right":"Code / JSON / structured data"},{"left":"Presenting a new product idea to stakeholders","right":"Report / document — sections with headers and evidence"}]}'></div>
