...
<div class="content">
  ...
  <div data-learn="MatchConnect" data-props='{"title":"Match the Question to the Right Tool","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"What is the weather in Tokyo right now?","right":"weather_api — real-time external data"},{"left":"How much did we spend last quarter?","right":"database — company-specific financial data"},{"left":"What is 10000 * 1.07 to the power of 20?","right":"calculator — precise math without hallucination"},{"left":"Email the team about the meeting change","right":"contacts + email — chained tool calls"},{"left":"What is the latest news on AI?","right":"web_search — current public information"}]}'></div>
