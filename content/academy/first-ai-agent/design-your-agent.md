...
<div class="content">
  ...
  <div data-learn="MatchConnect" data-props='{"title":"Match Agent Design Element to Its Role","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Agent Name","right":"A short, memorable identifier that makes the agent recognizable"},{"left":"Goal Statement","right":"One clear sentence defining what the agent accomplishes"},{"left":"Tool Selection","right":"2-4 focused capabilities that directly serve the agent\\\'s goal"},{"left":"Memory Definition","right":"What the agent remembers between sessions to improve over time"},{"left":"Guardrail","right":"A hard constraint the agent must never violate, even if asked"}]}'></div>
