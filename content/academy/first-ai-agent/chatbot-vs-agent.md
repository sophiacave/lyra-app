...
<div class="content">
  ...
  <div data-learn="MatchConnect" data-props='{"title":"Match the Behavior to the System","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Responds once and stops","right":"Chatbot"},{"left":"Loops until goal is met","right":"Agent"},{"left":"No memory between turns","right":"Chatbot"},{"left":"Calls tools to take actions","right":"Agent"},{"left":"Waits for every user input","right":"Chatbot"}]}'></div>
