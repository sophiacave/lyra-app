...
<div class="content">
  ...
  <div data-learn="MatchConnect" data-props='{"title":"Match the Agent Loop Step to What Happens","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Perceive","right":"Take in input from the environment — a message, API response, or trigger"},{"left":"Think","right":"Reason about goal, memory, and context to decide the best next action"},{"left":"Act","right":"Call a tool to take a real action — send email, query database, write file"},{"left":"Observe","right":"Check if the action succeeded or failed and what the result was"},{"left":"Learn","right":"Update memory with the outcome so future loops are smarter"}]}'></div>
