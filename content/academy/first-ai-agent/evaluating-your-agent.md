...
<div class="content">
  ...
  <div data-learn="MatchConnect" data-props='{"title":"Match Evaluation Dimension to Its Fix","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Low Accuracy","right":"Improve system prompt, add few-shot examples"},{"left":"Low Speed","right":"Cache queries, parallelize tool calls"},{"left":"Low Reliability","right":"Add retry logic and fallback tools"},{"left":"Low Cost Efficiency","right":"Route simple queries to cheaper models"},{"left":"Low User Satisfaction","right":"Add feedback loop, improve tone and format"}]}'></div>
