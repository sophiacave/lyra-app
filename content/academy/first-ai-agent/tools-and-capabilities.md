...
<div class="content">
  ...
  <div data-learn="MatchConnect" data-props='{"title":"Match Tool to Its Primary Use Case","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Web Search","right":"Find current information not in training data"},{"left":"Database","right":"Store and retrieve persistent structured data"},{"left":"Email","right":"Send and receive messages autonomously"},{"left":"API Caller","right":"Connect to any external service"},{"left":"Calculator","right":"Precise math without hallucination"}]}'></div>
