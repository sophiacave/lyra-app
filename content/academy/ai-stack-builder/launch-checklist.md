...
<div data-learn="MatchConnect" data-props='{"title":"Launch Category Matcher","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Enable RLS on all tables","right":"Security"},{"left":"Add database indexes","right":"Performance"},{"left":"Loading states for async actions","right":"UX"},{"left":"Switch to Stripe live mode","right":"Revenue"}]}'></div>
