...
<div data-learn="MatchConnect" data-props='{"title":"Match Edge Function Concepts","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Deno","right":"Modern JavaScript runtime with faster cold starts and better security defaults"},{"left":"Cold start","right":"Initial ~100ms delay when a function spins up after being idle"},{"left":"CORS headers","right":"Required when your frontend calls an edge function directly from the browser"},{"left":"Deno.env.get()","right":"Access environment variables like SUPABASE_URL without hardcoding secrets"},{"left":"new Response()","right":"The return value every edge function must send back to the caller"}]}'></div>
