...
<div data-learn="MatchConnect" data-props='{"title":"Stack Layer Matcher","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Supabase","right":"Database + Auth + Edge Functions"},{"left":"Vercel","right":"Frontend deploy + global CDN"},{"left":"Claude","right":"AI intelligence layer"},{"left":"Make.com","right":"Visual automation glue"}]}'></div>
