...
<div class="lesson-section">
  ...
  <div data-learn="MatchConnect" data-props='{"title":"Match the Architecture Level to Its Definition","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Pillars","right":"3-5 core themes your brand owns — everything traces back to one"},{"left":"Clusters","right":"Subtopics within a pillar that reinforce each other"},{"left":"Atoms","right":"Smallest reusable units — a stat, quote, framework, or story"},{"left":"Gap Analysis","right":"Identifying which topics and formats are missing from your architecture"},{"left":"Database Mindset","right":"Treating content as structured data with metadata so AI can work with it"}]}'></div>
