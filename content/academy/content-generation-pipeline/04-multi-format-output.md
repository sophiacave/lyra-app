...
<div class="lesson-section">
  ...
  <div data-learn="MatchConnect" data-props='{"title":"Match the Platform to Its Format Rules","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Twitter/X","right":"Punchy hooks, thread format, each tweet stands alone"},{"left":"LinkedIn","right":"Personal story angle, short paragraphs, engagement question"},{"left":"Email Newsletter","right":"Intimate first-person tone, tease one insight, clear CTA"},{"left":"YouTube Script","right":"Two-column format, retention hooks at 30s and 2min, visual cues"},{"left":"Instagram Carousel","right":"7 slides, one idea per slide, hook on slide 1, CTA on slide 7"}]}'></div>
