...
<div class="lesson-section">
  ...
  <div data-learn="MatchConnect" data-props='{"title":"Match the Distribution Day to Its Action","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Day 0","right":"Blog publishes, email newsletter sends, Twitter thread posts"},{"left":"Day 1","right":"LinkedIn post with different angle, Instagram carousel queued"},{"left":"Day 3","right":"Follow-up tweet with quote graphic, cross-post to communities"},{"left":"Day 7","right":"ICYMI email to non-openers, repurposed short-form video"},{"left":"Day 30","right":"Performance review, feed results back into the pipeline"}]}'></div>
