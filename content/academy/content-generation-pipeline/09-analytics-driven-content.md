...
<div class="lesson-section">
  ...
  <div data-learn="MatchConnect" data-props='{"title":"Match the Metric Category to What It Measures","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Engagement Depth","right":"Time on page, scroll depth, comment quality"},{"left":"Conversion Actions","right":"Clicks, signups, downloads, purchases"},{"left":"Content Efficiency","right":"Production time vs. performance, cost per piece vs. revenue"},{"left":"Vanity Metrics","right":"Likes, impressions, follower counts — feel good but do not drive decisions"}]}'></div>
</div>
