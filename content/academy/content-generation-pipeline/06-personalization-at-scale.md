...
<div class="lesson-section">
  ...
  <div data-learn="MatchConnect" data-props='{"title":"Match the Personalization Variable to Its Purpose","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"{{PAIN_POINT}}","right":"The specific frustration driving each audience segment"},{"left":"{{TECHNICAL_LEVEL}}","right":"How much the segment already knows — adjusts complexity and jargon"},{"left":"{{INDUSTRY_EXAMPLE}}","right":"A relevant case study or scenario from the segment\\\'s world"},{"left":"{{ASPIRATION}}","right":"What the segment wants to achieve — their motivating goal"},{"left":"Segment Profile Document","right":"A lookup table of variable values per audience group"}]}'></div>
