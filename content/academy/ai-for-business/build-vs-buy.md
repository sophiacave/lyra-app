...
<div class="lesson-hero">
  <h1>Build vs. <span class="accent">Buy.</span></h1>
  <p class="sub">Should you build a custom AI solution, buy a SaaS tool, hire a consultant, or just wait? This lesson gives you the framework to decide — fast.</p>
</div>

<div class="learn-card">
  <h3>After this lesson you'll know</h3>
  <ul>
    <li>The four strategic options: Build, Buy, Hire, and Wait — and when each is right</li>
    <li>The 5 key factors that determine which option fits your situation</li>
    <li>How to match real business scenarios to the right approach</li>
    <li>Which factor should carry the most weight in your decision</li>
  </ul>
</div>
...
<div class="lesson-section">
  ...
  <p class="section-text"><strong>2. Budget.</strong> Not just what you have, but what makes financial sense given the expected ROI. A $500/year tool that saves $10,000 is a no-brainer. A $50,000 custom build for a problem that saves $8,000 per year is a five-year payback — maybe not worth it. Use the ROI formula from Lesson 3 before making any budget commitment.</p>

  <p class="section-text"><strong>3. Technical Capability.</strong> What can your team actually maintain after the initial setup? A custom-built solution with no one to support it becomes a liability. If you have no technical staff, anything that requires ongoing development is a hire or buy decision — not a build. Be honest about this. Many businesses overestimate their internal technical capacity.</p>
...
<div class="lesson-section">
  ...
  <h2 class="section-title">Make the call.</h2>
  <p class="section-text">Five scenario-based questions. For each one, apply the five factors and recommend the right strategy. These are real decisions — not edge cases.</p>

  <div data-learn="QuizMC" data-props='{"title":"Build vs. Buy Decisions","questions":[{"q":"A 10-person marketing agency wants to use AI to generate first drafts of blog posts and social content. Their budget is $200/month and they need to start this week. What is the right call?","options":["Build — agencies need custom models for brand consistency","Buy — this is a common problem with excellent SaaS tools that deploy in hours","Hire a consultant — content is too brand-sensitive for off-the-shelf tools","Wait — AI writing tools are still too immature for professional content"],"correct":1,"explanation":"Common problem, reasonable budget, urgent timeline, no sensitive data. This is a textbook Buy scenario. Tools like Jasper, Claude, or Copy.ai handle this well at $20-$100/month and can be up and running same day."},{"q":"A wealth management firm wants AI to analyze client portfolios and suggest rebalancing strategies. Client financial data is involved. Budget: $50,000. What is the right call?","options":["Buy — plenty of fintech SaaS tools handle portfolio analysis","Wait — financial AI is too risky for wealth management","Build or hire a specialist — financial data sensitivity and regulatory requirements rule out generic SaaS","Hire a general AI consultant for a quick setup"],"correct":2,"explanation":"Client financial data (PII + regulated) and the high-stakes nature of portfolio recommendations require a solution built with compliance in mind. A generic SaaS tool cannot guarantee the data privacy or regulatory controls required. Build or hire a specialist with fintech AI experience."},{"q":"A restaurant owner wants to use AI to respond to Google reviews and social media comments. She has no technical staff. Budget: $30/month. What is the right call?","options":["Build — review responses need to sound like her specifically","Buy — SaaS tools like Podium or a general AI assistant handle this well","Hire a consultant to build a custom review response system","Wait — AI social media tools are not ready for restaurant use"],"correct":1,"explanation":"Classic Buy scenario. The problem is common, the budget fits, there is no sensitive data, and she needs it to work without technical maintenance. Tools like Podium, Birdeye, or even Claude with a simple prompt template solve this for under $30/month."},{"q":"A logistics company wants to predict delivery delays using 5 years of their proprietary shipment data, weather patterns, and carrier performance records. Budget: $80,000. They have two developers. What is the right call?","options":["Buy — logistics SaaS tools can handle this without custom development","Wait — predictive AI is too expensive for most logistics businesses","Build — the problem is unique, data is proprietary, team has technical capacity, and budget supports it","Hire a consultant for a 2-week setup"],"correct":2,"explanation":"Unique problem (proprietary 5-year dataset), significant budget, technical staff available, and the competitive advantage of a custom model justifies the investment. This is one of the rare scenarios where Build is the right answer."},{"q":"A small nonprofit wants AI to help draft grant applications. Budget: $0 (no AI spend authorized). Timeline: 3 months before next grant cycle. What is the right call?","options":["Hire a consultant — grant writing is too important to risk on free tools","Build a custom model on volunteer developer time","Use free tiers of existing AI tools — Claude free, ChatGPT free, or similar","Wait until the board approves a budget"],"correct":2,"explanation":"Zero budget does not mean zero options. Claude, ChatGPT, and Gemini all have free tiers that handle grant writing drafts well. Start there, demonstrate value, then make the case for a small paid subscription. Do not wait — use what is available now."}]}'></div>
</div>
