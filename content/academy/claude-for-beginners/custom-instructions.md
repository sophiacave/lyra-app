...
<div data-learn="MatchConnect" data-props='{"title":"Find Your Template","instruction":"Match each work style to the right custom instruction template","pairs":[{"left":"I manage people, budgets, and deadlines","right":"Executive Template — concise, action-oriented, no fluff"},{"left":"I write copy, design, or create content","right":"Creative Template — flexible, exploratory, idea-rich"},{"left":"I work with numbers, reports, and systems","right":"Analyst Template — precise, data-driven, structured"},{"left":"I write docs, blog posts, or communications","right":"Writer Template — tone-aware, editing-focused, audience-first"}]}'></div>
