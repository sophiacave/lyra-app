...
<div data-learn="MatchConnect" data-props='{"title":"Match Claude Concepts","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Role","right":"Tell Claude WHO it should be for this task"},{"left":"Context","right":"Give Claude the situation, background, and constraints"},{"left":"Format","right":"Specify what you want back — bullets, email, table"},{"left":"Verify facts","right":"Always double-check important claims from any AI"},{"left":"Thinking partner","right":"How to think about Claude — a coworker who amplifies you"}]}'></div>
