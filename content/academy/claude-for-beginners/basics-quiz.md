...
<!-- FLASHDECK — Review before the quiz -->
<div data-learn="FlashDeck" data-props='{"title":"Claude Basics Review","cards":[{"front":"What is Claude?","back":"An AI assistant made by Anthropic that can read, write, analyze data, brainstorm, and more — all through natural conversation."},{"front":"The 3-Part Prompt Formula","back":"Role (who Claude should be) + Context (the situation) + Format (what you want back). This formula works for almost any prompt."},{"front":"Can Claude access the internet?","back":"Yes — since March 2025, Claude can search the web for current information. But always verify important facts with a reliable source."},{"front":"How should you think about Claude?","back":"A brilliant coworker who makes you faster and better. It does not replace you — it amplifies you. Human judgment + AI capability is unstoppable."},{"front":"Trust but verify","back":"Claude is excellent at reasoning and writing but can occasionally get specific facts wrong. Always verify important claims before using them in presentations or decisions."}]}'></div>

<!-- MATCHCONNECT — Practice matching -->
<div data-learn="MatchConnect" data-props='{"title":"Claude Concepts Review","instruction":"Match each Claude concept to its description","pairs":[{"left":"The 3-Part Formula","right":"Role + Context + Format"},{"left":"Context Window","right":"How much Claude can remember in one conversation"},{"left":"Custom Instructions","right":"Persistent preferences that shape every conversation"},{"left":"Verification","right":"Always double-check important facts from Claude"},{"left":"Claude Projects","right":"Dedicated spaces with uploaded files for specific work areas"},{"left":"Prompt Specificity","right":"The more detail you give, the better Claude responds"}]}'></div>
...
<div data-learn="LessonComplete" data-props='{"courseSlug":"claude-for-beginners","lessonNum":3}'></div>
