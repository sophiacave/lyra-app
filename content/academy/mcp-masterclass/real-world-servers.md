...
<div class="lesson-container">
  ...
  <div data-learn="MatchConnect" data-props='{"title":"Match Server to Primary Use Case","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Database Server","right":"Analyze data and generate reports from SQL queries"},{"left":"GitHub Server","right":"Review PRs, manage issues, search codebases"},{"left":"Slack Server","right":"Post team updates and summarize channel threads"},{"left":"Memory Server","right":"Persist knowledge and recall facts across sessions"}]}'></div>
