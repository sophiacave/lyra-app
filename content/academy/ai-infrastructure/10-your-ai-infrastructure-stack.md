...
<div class="lesson-section">
  <div data-learn="FlashDeck" data-props='{"title":"Your AI Infrastructure Stack","cards":[{"front":"Week 1: Foundation","back":"Set up Vercel + Supabase. Deploy a basic app. Confirm CI/CD works — push to main, see it live."},{"front":"Week 2: AI Integration","back":"Add your first AI API call through an edge function. Store keys in env vars. Log every call to your operations table."},{"front":"Week 3: Vector Search","back":"Enable pgvector. Build a RAG pipeline — embed content, store vectors, query by similarity, inject context into prompts."},{"front":"Week 4: Hardening","back":"Add rate limiting, input validation, output checking, response caching, cost alerts, and post-deploy smoke tests."},{"front":"Biggest Pitfall: Over-Engineering Day One","back":"You don\\\'t need Kubernetes or multi-region deployment for your first 1,000 users. Start simple. Add complexity when simple breaks."}]}'></div>
</div>
