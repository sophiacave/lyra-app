...
<div data-learn="MatchConnect" data-props='{"title":"Match Agent Component to Its Purpose","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Goal","right":"What the agent is trying to accomplish autonomously"},{"left":"Tools","right":"External capabilities the agent can invoke to take real actions"},{"left":"Memory","right":"How the agent retains context across loops and sessions"},{"left":"Guardrails","right":"Safety limits preventing destructive or unauthorized actions"},{"left":"Deploy","right":"Launching the configured agent and verifying its behavior"}]}'></div>
