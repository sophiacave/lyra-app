...
<div data-learn="MatchConnect" data-props='{"title":"Match the Few-Shot Concept","instruction":"Tap one on the left, then its match on the right","pairs":[{"left":"Zero-shot","right":"No examples provided — relies entirely on training knowledge"},{"left":"Few-shot","right":"2-5 input-output examples that teach Claude a pattern"},{"left":"Edge case example","right":"A tricky boundary condition that prevents default-class bias"},{"left":"Consistent formatting","right":"All examples follow the exact same structure and style"},{"left":"Example ordering","right":"Most representative first, most complex last"}]}'></div>
