...
|-------|------|-------------|
| Conversation & copy | Claude Pro | $20 |
| Automation engine | Make.com (Pro) | $9 |
| Email & nurture | ConvertKit (Creator) | $29 |
| CRM | HubSpot (Free) or Notion | $0 |
| Scheduling | Cal.com (Free) | $0 |
| Lead enrichment | Apollo.io (Free tier) | $0 |
| Proposals | Notion + Claude API | ~$5 |
| Payments | Stripe | 2.9% + 30¢ per transaction |
| **Total** | | **~$63/month + Stripe fees** |
...
*Ready to build your AI-powered sales funnel? [Like One Academy](/academy) walks you through every tool and workflow — step by step.*
