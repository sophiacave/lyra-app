...
faq:
  - q: "What is an AI readiness assessment?"
    a: "An AI readiness assessment evaluates your organization's ability to successfully adopt and deploy AI systems. It measures five dimensions: data infrastructure, team capability, process maturity, budget reality, and organizational culture. Unlike generic maturity models, a useful assessment gives you concrete next steps rather than a meaningless score."
  - q: "How do I know if my company is ready for AI?"
    a: "Your company is ready for AI if you can answer yes to three questions: Do you have clean, accessible data for at least one business process? Is there at least one person who understands what AI can and cannot do? Does leadership support experimentation without demanding immediate ROI? If you hit all three, you can start. You do not need perfection across every dimension."
  - q: "What is the difference between AI readiness and AI maturity?"
    a: "AI readiness measures whether you can start adopting AI effectively. AI maturity measures how far along you are in that adoption. Readiness is a prerequisite assessment — it tells you where to begin. Maturity is a progress metric — it tells you how sophisticated your AI operations have become over time."
  - q: "Can I use AI to assess my own AI readiness?"
    a: "Yes. Tools like Claude and ChatGPT can analyze your current tech stack documentation, interview transcripts, and process maps to identify gaps in your AI readiness. You can feed them your infrastructure diagrams, team org charts, and budget spreadsheets to get a structured assessment. The key is providing honest inputs — AI cannot fix the garbage-in problem."
  - q: "How long does an AI readiness assessment take?"
    a: "A meaningful self-assessment takes two to five days if you use the five-dimension framework. Enterprise assessments with external consultants typically take four to eight weeks and cost six figures. The self-assessment approach outlined in this guide gets you 80% of the value in 5% of the time."
---
...
If you want to understand the strategic context behind readiness, the [AI Enterprise Strategy](/academy/ai-enterprise-strategy/) course covers how assessment fits into broader organizational planning. But strategy without honest self-evaluation is just wishful thinking.
...
For a deeper dive into what production-grade data systems look like, the [AI Infrastructure](/academy/ai-infrastructure/) course covers the full stack from data pipelines to deployment architecture.
...
The [AI Foundations](/academy/ai-foundations/) course at Like One Academy exists specifically to close this gap. It takes people from "AI is magic" to "AI is a tool I understand how to evaluate and apply."
...
For a structured approach to building AI-powered evaluation tools like this, the [Building AI Products](/academy/building-ai-products/) course walks through the full product development lifecycle.

## What to Do With Your Score

**0-5: Foundation Phase.** Do not buy AI platforms. Start with AI literacy training for your team, basic data cleanup, and identifying one process that could benefit from AI assistance. Use off-the-shelf tools like Claude or ChatGPT to solve real problems manually before building anything custom. The [AI Readiness Assessment lesson](/academy/ai-enterprise-strategy/03-ai-readiness-assessment/) provides a structured approach to planning this phase.
...
**11-15: Scale Phase.** You are ready to move beyond pilots. Build internal AI tooling, hire or develop dedicated AI talent, and create a repeatable process for evaluating and deploying AI across business units. This is where an [AI infrastructure](/academy/ai-infrastructure/) investment starts paying compound returns.
