...
const LO = {
  ...
  showToast(msg) {
    ...
    toast.style.cssText = 'position:fixed;bottom:24px;left:50%;transform:translateX(-50%) translateY(10px);background:#242428;color:#e5e5e5;border:1px solid #2a2a38;padding:10px 24px;border-radius:10px;font-family:Inter,sans-serif;font-weight:600;font-size:14px;z-index:99999;opacity:0;transition:all .3s;pointer-events:none;';
