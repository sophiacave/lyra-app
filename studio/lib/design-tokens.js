...
export const RENDERING_PRESETS = {
  ...
  comparisonSplit: {
    ...
    grain: 0.02,
    letterbox: false,
    glow: { radius: 200, opacity: 0.03 },
    composition: 'split 50/50, vertical divider, accent-colored headers',
  },
  dataViz: {
    type: 'diagram',
    ...
    composition: 'center, animated bars/rings, colorblind-safe palette',
  },
  stepByStep: {
    type: 'diagram',
    ...
    grain: 0.025,
    letterbox: false,
    glow: { radius: 250, opacity: 0.04 },
    composition: 'sequential reveal, numbered steps with connecting lines',
  },
  montageScene: {
    type: 'montage',
